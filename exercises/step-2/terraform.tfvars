...
location            = "westeurope"
resource_group_name = "rg-workshop-step2gh-dev-we-001"

# Virtual Network
vnet_name          = "vnet-workshop-step2gh-dev-we-001"
vnet_address_space = ["10.0.0.0/16"]

# Subnet
subnet_name             = "snet-workshop-step2gh-dev-we-001"
subnet_address_prefixes = ["10.0.1.0/24"]

# Network Interface
nic_name = "nic-workshop-step2gh-dev-we-001"

# Storage Account (nazwa musi być globalnie unikalna, 3-24 znaki, tylko lowercase)
storage_account_name = "stworkshopstep2ghdev001"
